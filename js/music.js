...
const questions = [
    { question: "How many strings does a standard guitar have?", options: ["A. 4", "B. 5", "C. 6", "D. 7"], correct: 2 },
    { question: "What is the name of the Beatles' debut album?", options: ["A. Abbey Road", "B. Please Please Me", "C. Rubber Soul", "D. Help!"], correct: 1 },
    { question: "Who is known as the King of Pop?", options: ["A. Elvis Presley", "B. Prince", "C. Michael Jackson", "D. Freddie Mercury"], correct: 2 },
    { question: "What is the smallest woodwind instrument?", options: ["A. Flute", "B. Clarinet", "C. Piccolo", "D. Recorder"], correct: 2 },
    { question: "What note is a perfect fifth above C?", options: ["A. D", "B. E", "C. F", "D. G"], correct: 3 },
    { question: "Which instrument has 88 keys?", options: ["A. Organ", "B. Harpsichord", "C. Piano", "D. Synthesizer"], correct: 2 },
    { question: "Who composed the opera 'The Magic Flute'?", options: ["A. Beethoven", "B. Bach", "C. Mozart", "D. Wagner"], correct: 2 },
    { question: "What genre did Elvis Presley help popularize?", options: ["A. Jazz", "B. Blues", "C. Rock and roll", "D. Country"], correct: 2 },
    { question: "What is the Italian term for 'loud' in music?", options: ["A. Piano", "B. Forte", "C. Crescendo", "D. Allegro"], correct: 1 },
    { question: "Which band sang 'Bohemian Rhapsody'?", options: ["A. The Beatles", "B. Led Zeppelin", "C. Queen", "D. Pink Floyd"], correct: 2 },
];
